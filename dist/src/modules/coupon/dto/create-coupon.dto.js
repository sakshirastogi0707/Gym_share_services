...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ type: Date }),
    __metadata("design:type", Date)
], CreateCouponDto.prototype, "startingDate", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.Length)(6, 6, { message: 'Code must be exactly 6 characters long' }),
...
], CreateCouponDto.prototype, "isExpired", void 0);
__decorate([
    (0, class_validator_1.IsBoolean)(),
