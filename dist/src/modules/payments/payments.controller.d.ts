...
export declare class PaymentsController {
    ...
    constructor(paymentService: PaymentsService, stripeService: StripeService);
    getPublishableKey(): Promise<{
        status: boolean;
        message: string;
        data: string;
    }>;
    createStripeIntent(body: StripeIntentRequestDto, req: Request): Promise<{
        status: boolean;
        message: string;
        data: {
    ...
    refundPayment(body: RefundPaymentDto): Promise<{
        status: boolean;
        message: any;
        data: any;
    }>;
    getSavedCards(req: Request): Promise<{
        status: boolean;
        message: string;
        data: {
            id: string;
